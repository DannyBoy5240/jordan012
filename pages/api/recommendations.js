...
const recommendationCard = [
  ...
  },
  {
    ...
    view: "I wholeheartedly recommend Jordan as a talented React frontend developer with an incredible flair for UI/UX design. His proficiency in Node.js further enhances his capabilities, allowing him to build robust and scalable applications. Jordan's attention to detail, problem-solving skills, and dedication to delivering exceptional results make him a valuable addition to any development team.",
    linkednURL: "#"
  },
  {
    id: 2,
  ...
  },
  {
    ...
    view: "Jordan went above and beyond on this project - like always. In the past, my company has tried many outside resources for projects similar to this but the reason we keep utilizing Jordan is his work ethic and his quality of work and would highly recommend him",
    linkednURL: "#"
  },
  {
    id: 13,
  ...
  },
  {
    ...
    view: "Another successful job done perfectly well by Jordan and his dev team. He nailed down an entire social media module containing Timeline, Newsfeed (containing Likes, Comments, Share), B2B store integration with social media platform and real time chat. He is pros in Laravel, AWS, JavaScript and React alongside API development and integration. Highly recommended",
    linkednURL: "#"
  },
  {
    id: 15,
    ...
    view: "Great to work with Jordan. Delivers great work and communicates very well in earnest intent to complete the project as I have envisioned.",
    linkednURL: "#"
  },
]
